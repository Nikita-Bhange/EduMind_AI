          ...
          <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-500">
            ...
            <div className="flex gap-3 m-3">
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-11 px-4 border-2 border-slate-200 rounded-xl bg-white text-slate-700 hover:bg-slate-50 transition"
              >
                Cancel
              </button>
              ...
              <button
                ...
                disabled={deleting}
                className="flex-1 h-11 px-4 rounded-xl text-white bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 transition flex items-center justify-center"
              >
                {deleting ? (
