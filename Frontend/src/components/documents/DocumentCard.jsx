...
const DocumentCard = ({ document, onDelete }) => {
  ...
  return (
    <div
      className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-1.5"
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-4">
        ...
        <button
          ...
          className="opacity-0 group-hover:opacity-100 text-slate-500 hover:text-slate-900 transition-opacity duration-200"
        >
